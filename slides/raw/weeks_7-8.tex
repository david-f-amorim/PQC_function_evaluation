...
\item Thus, it seems like a \alert{$\sim \mathcal{O}(2^m n m)$ complexity} is to be expected for this algorithm [NO! A N-CONTROLLED OPERATION HAS A COST HIGHER THAN N!!] => READ PAPERS (BOOKMARKED!)
